...
window.addEventListener("resize", () => {
    ...
    if(clientWidth < 1160) {
        ...
        themeDiaBox.classList.add("d-none");
        container.classList.add("d-none");
        hobbiesContainer.classList.add("d-none");
        hobbiesDialog.classList.add("d-none");
        middle_Set.classList.add("d-none");
        sideBar.classList.add("d-none");
    } else {
        themeDiaBox.classList.remove("d-none");
        container.classList.remove("d-none");
        hobbiesContainer.classList.remove("d-none");
        hobbiesDialog.classList.remove("d-none");
        middle_Set.classList.remove("d-none");
